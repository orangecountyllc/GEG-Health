...
$(document).ready(function () {
  ...
  */
	...
	var pageUrl = 'others';
	if (pathName === '/content/equity-web/en.html' || pathName === '/' || pathName === '/jp' || pathName === '/jp/' || pathName === '/cn' || pathName === '/cn/' || pathName === '/mx' || pathName === '/mx/' || pathName === '/de' || pathName === '/de/' || pathName === '/content/equity-web/en/australia.html' || pathName === '/australia.html') {
		pageUrl = 'home';
	}
...
(function(window) {
	...
	var pathName = window.location.pathname.toLowerCase();
	var pageUrl = 'others';
	if (pathName === '/content/equity-web/en.html' || pathName === '/' || pathName === '/jp' || pathName === '/jp/' || pathName === '/cn' || pathName === '/cn/' || pathName === '/mx' || pathName === '/mx/' || pathName === '/de' || pathName === '/de/') {
		pageUrl = 'home';
	}
...
function vplayercall(istreamfile, hei, contid, startmode) {
	jwplayer(contid).setup({
		'autostart': startmode,
		'flashplayer': '/content/dam/equity-web/en/audio/vplayer.swf',
...
//		'logo.position': 'top-left',															commented   	
		'author': 'Equity Dental Partners',
		'abouttext': 'Equity Dental Partners',
...
//   var urlParams = new URLSearchParams(window.location.search);
    ...
    if(queryPart!=null)
    {
        queryURL="/bin/equity/press-release?currentItemsCount="+itemsCount+"&ispr="+ispr+"&isevents="+isevents+"&url="+url+queryPart;
    }
    else
    {
        queryURL="/bin/equity/press-release?currentItemsCount="+itemsCount+"&ispr="+ispr+"&isevents="+isevents+"&url="+url;
    }
        ...
        
    {
        ...
        if(pressReleaseItem && pressReleaseItem.length>0){
            ...
            if(pagereflink && $(pressReleaseItem).find('.press-releaseDownload').length>0){
                ...
                var downloadHTML = "<li class='download '><a class='social-tag-icon press-releaseDownload' href='"+loadMoreRefLink+"' target='"+loadMorePDFOpenInNewTab+"' title='Download'><img src='/content/dam/equity-web/en/global-resource/responsive/newdesign/download.svg' alt='download'/></a></li>";
